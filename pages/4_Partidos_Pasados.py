...
def get_data():
    ...
    url = 'https://forzafootball.com/tournament/womens-wc-566/results'
    url = 'https://forzafootball.com/tournament/national-womens-soccer-league-1221/results'
    url1 = 'https://forzafootball.com/tournament/women%E2%80%99s-super-league-1549/results'
...
with past:
    st.markdown(f"<h1 style='text-align: center;'>Partidos pasados</h1>", unsafe_allow_html=True)
    st.write('###')
    global_stage = ''

    if fix.empty:
        st.write('###')
        st.markdown(f"<h3 style='text-align: center;'>No hay partidos pasados</h3>", unsafe_allow_html=True)
    else:
